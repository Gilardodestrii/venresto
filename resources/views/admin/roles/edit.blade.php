...
<div class="container mx-auto px-4">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h3 class="text-2xl font-bold text-gray-900 mb-1">Edit Staff</h3>
            <div class="text-sm text-gray-500">Ubah data staff dan role</div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <form method="POST"
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Password <span class="text-gray-400 font-normal">(kosongkan jika tidak diubah)</span></label>
                        <input type="password"
                               name="password"
