...
Route::match(['GET', 'POST'], '/switch-tenant/{tenant}', function ($tenant) {
    $user = auth()->user();
...
// Sitemap XML untuk SEO — static file approach (no middleware interference)
// Sitemap is generated via artisan command: php artisan sitemap:generate
